 ...
 */
 ...
 $config = [
    ...
    'import_error' => "Echec de l'importation des données",
    'data_imported' => 'Données importées',
    'data_exported' => 'Données exportées',
    'email_not_verifed' => "Compte pas encore activé.",
    ...
    'verify_email_link_sent' => 'Lien de confirmation envoyé à votre adresse email',
    'verify_email_link_not_sent' => "Echec de l'envoie de l'email de confirmation",
